...
public class AdminController implements StatelessAppleController {
    ...
    private void insertPublisherByName(AppleResponse res, AppleRequest req) {
        ...
        if ("".equalsIgnoreCase(publishername) || publishername == null) {
            messages = "<message>Utgivernavn må angis</message>";
        ...
        String findPublisherByNameQuery =
                "PREFIX dct: <http://purl.org/dc/terms/>\n" +
                "PREFIX foaf: <http://xmlns.com/foaf/0.1/>\n" +
                "DESCRIBE ?resource ?publisher ?subject\n" +
                "WHERE {\n" +
        ...
        if(queryResult.toString().contains(publishername)) {
            messages = "<c:message>En utgiver med det navnet finnes allerede registrert</c:message>";
            showPublishersIndex(res, req, messages);
            return;
        }
        ...
        String insertPublisherByName =
                ...
                "INSERT\n" +
                "{\n" +
                "<" + publisherURI + "> dct:publisher ?publisher ;\n" +
                "?publisher foaf:name \"" + publishername + "\"@no .\n" +
                "}";
        ...
        if (success) {
            messages = "Lagring av ny utgiver vellykket";
        } else {
            messages = "Feil ved lagring av ny utgiver";
            showPublishersIndex(res, req, messages);
            return;
        }
    ...
    private void updatePublisherByURI(AppleResponse res, AppleRequest req) {
        ...
        updateStringBuffer.append("PREFIX dct: <http://purl.org/dc/terms/>\n");
        updateStringBuffer.append("PREFIX foaf: <http://xmlns.com/foaf/0.1/>\n");
        updateStringBuffer.append("INSERT {\n");
        ...
        for (String s : parameterMap.keySet()) {
            if (s.contains("@")) {
                ...
                String[] partialString2 = partialString[0].split("/");
                deleteStringBuffer.append("<" + publisheruri + "> " + partialString2[0] + " ?publisher ;\n");
                deleteStringBuffer.append(partialString2[1] + " ?oldname@" + partialString[1] + " .\n");
                whereStringBuffer.append("<" + publisheruri + "> " + partialString2[0] + " ?publisher ;\n");
                whereStringBuffer.append(partialString2[1] + " ?oldname@" + partialString[1] + " .\n");
                updateStringBuffer.append("<" + publisheruri + "> " + partialString2[0] + " ?publisher ;\n");
                updateStringBuffer.append(partialString2[1] + " \"" + parameterMap.get(s) + "\"" + "@" + partialString[1] + " .\n");
            }
        }
        ...
        String updateString = updateStringBuffer.toString();
        ...
        logger.info("updatePublisherByURI() ---> " + publisheruri + " -- SPARUL INSERT  --> " + updateString);
        success = false;
