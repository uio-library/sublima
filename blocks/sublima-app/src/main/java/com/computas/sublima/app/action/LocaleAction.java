 ...
 */
package com.computas.sublima.app.action;
...
public class LocaleAction extends ServiceableAction implements ThreadSafe, Configurable {
    ...
    private static final String DEFAULT_DEFAULT_LANG = "no";
    private static final String DEFAULT_DEFAULT_COUNTRY = "NO";
    ...
    throws ConfigurationException {
        ...
        if (child != null) {
            this.defaultLocale = new Locale("no",
