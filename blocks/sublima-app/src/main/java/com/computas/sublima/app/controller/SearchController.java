...
public class SearchController implements StatelessAppleController {
    ...
    public void process(AppleRequest req, AppleResponse res) throws Exception {
        ...
        if ("advancedsearch".equalsIgnoreCase(mode)) {
            ...
            bizData.put("approvers", adminService.getDistinctAndUsedLabels("<http://rdfs.org/sioc/ns#User>", "<http://xmlns.computas.com/sublima#lastApprovedBy>"));
    ...
    public void doAdvancedSearch(AppleResponse res, AppleRequest req) {
        ...
        String moreThanZeroHitsQuery = null;
        ...
        if (parameterMap.get("prefix") != null) {
            ...
            // Keep a copy of the original parameterMap so that we can reuse it later
            ...
            if (freetext && zeroHitsStrategyEnables) {
                ...
                if (moreThanZeroHitsResult == null || !moreThanZeroHitsResult.contains("<uri>")) {

                    form2SparqlService.setDeepsearch(true);
