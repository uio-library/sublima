...
public class Form2SparqlServlet extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request,
    ...
    if (parameterMap.get("prefix") != null) {
      //Calls the Form2SPARQL service with the parameterMap which returns a SPARQL as String
      ...
      try {
        URL u = new URL("http://localhost:8180/sublima-1.0-SNAPSHOT/sparql?query="
                + URLEncoder.encode(sparqlQuery, "UTF-8")); // TODO: Should have a config somewhere
